// <copyright file="JokeOfTheDayClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace JokeOfTheDay.Standard
{
    using System;
    ...
    using JokeOfTheDay.Standard.Controllers;
    ...
    /// </summary>
    public sealed class JokeOfTheDayClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Default, "https://api.jokes.one" },
                }
            },
        };
        ...
        /// <summary>
        /// Creates an object of the JokeOfTheDayClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> JokeOfTheDayClient.</returns>
        internal static JokeOfTheDayClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("JOKE_OF_THE_DAY_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = JokeOfTheDay.Standard.Environment.Production;
